...
class QueryTestHandler extends AbstractHandler implements HandlerInterface
{
    ...
    const SKELETON_DIR = 'Api/Tests/Application/Entity/Query/Handler';
    const SKELETON_TPL = '%sQueryHandlerTest.php.twig';

    protected $targetPattern = '%s/%s/Tests/Application/%s/Query/Handler/%sQueryTest.php';
    protected $target;
